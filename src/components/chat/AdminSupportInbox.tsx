        ...
        <div className="px-4 py-3 border-b border-gray-200 flex flex-col gap-3">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              aria-label="Aggiorna lista richieste supporto"
              className="text-sm px-3 py-1.5 rounded-lg bg-gray-100 hover:bg-gray-200 disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
            >
              {isRefreshing && (
