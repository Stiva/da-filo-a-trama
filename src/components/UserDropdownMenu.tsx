    ...
    useEffect(() => {
        ...
        const handleEscape = (e: KeyboardEvent) => {
            if (e.key === 'Escape') {
                ...
                const triggerButton = menuRef.current?.querySelector('button[aria-haspopup="menu"]') as HTMLButtonElement | null;
                if (triggerButton) {
                    triggerButton.focus();
                }
            }
                ...
                >
                    ...
                    <div className="py-1">
                        <Link
                            ...
                            className="flex items-center gap-3 px-4 py-2.5 text-sm text-gray-700 hover:bg-agesci-yellow/20 transition-colors focus:bg-agesci-yellow/20 focus:outline-none"
                        >
                        ...
                        <button
                            ...
                            className="w-full flex items-center gap-3 px-4 py-2.5 text-sm text-red-600 hover:bg-red-50 transition-colors focus:bg-red-50 focus:outline-none"
                        >
