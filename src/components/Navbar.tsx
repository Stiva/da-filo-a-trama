          ...
          <div className="flex justify-between h-16">
            ...
            <div className="flex items-center gap-3">
              ...
              <Link
                ...
                className="hidden lg:flex w-10 h-10 rounded-full overflow-hidden ring-2 ring-agesci-yellow ring-offset-2 ring-offset-scout-cream bg-agesci-blue/10 items-center justify-center hover:scale-105 transition-transform"
              >
                {avatarImageUrl ? (
