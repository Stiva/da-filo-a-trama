...
/**
 * POST /api/events/[id]/groups/[groupId]/attachments/upload
...
export async function POST(
  ...
  try {
    ...
    const filePath = `groups/${groupId}/${crypto.randomUUID()}${fileExtension}`;
    ...
    console.error('Errore POST /api/events/[id]/groups/[groupId]/attachments/upload:', error);
    return NextResponse.json(
