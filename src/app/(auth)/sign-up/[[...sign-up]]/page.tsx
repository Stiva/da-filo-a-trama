  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-scout-cream">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-40 -left-40 w-80 h-80 bg-lc-green/20 rounded-full blur-3xl" />
        <div className="absolute -bottom-40 -right-40 w-80 h-80 bg-agesci-yellow/20 rounded-full blur-3xl" />
      </div>
      ...
      <div className="relative z-10">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-agesci-blue/60 text-sm mt-1">Unisciti all&apos;avventura!</p>
        </div>
